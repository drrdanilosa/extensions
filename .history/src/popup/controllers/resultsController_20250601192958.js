...
export class ResultsController {
     ...
     */    getCategoryLabel(category) {
        const labels = {
            ...
            'cam': '📹 Sites de Cam',
            'portfolio': '🎨 Portfolio',
            'casting': '🎭 Casting/Agências',
            'forum': '💬 Fóruns/Comunidades',
            'archive': '📚 Arquivos Web',
            'linkinbio': '🔗 Links na Bio',
            'images': '🖼️ Compartilhamento de Imagens',
            'dev': '👨‍💻 Desenvolvimento',
            'escort': '💄 Acompanhantes/Encontros',
