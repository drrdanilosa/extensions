...
export class PlatformService {
    ...
    _loadPlatforms() {
        return [
            ...
            { name: 'XHamsterLive', url: 'https://xhamsterlive.com/{username}', icon: '🐹', category: 'cam', priority: 'high' },            { name: 'CamWhores.tv', url: 'https://camwhores.tv/{username}', icon: '📺', category: 'cam', priority: 'high' },
