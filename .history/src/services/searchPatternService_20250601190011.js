/**
 * Search Pattern Service - Serviço de padrões de busca
 * @version 3.0.0
 */
...
export class SearchPatternService {
    ...
    /**
     * Obter todos os padrões de busca
     */
    getAllPatterns() {
    ...
    /**
     * Obter padrões relacionados a um termo de busca
     */
    getRelatedPatterns(term) {
