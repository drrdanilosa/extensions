...
// Palavras-chave e padrões de busca associados - EXPANDIDO v3.1
var searchPatterns = [
...
// Sites de fóruns e comunidades para busca indireta - EXPANDIDO v3.1
var forumSites = [
    // 🟫 Fóruns e Comunidades Leak/Adult
    { name: 'Leak.sx', url: 'https://leak.sx/search?q={username}', icon: '💧', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'Fapello', url: 'https://fapello.com/search/{username}', icon: '🔍', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'Coomer.party', url: 'https://coomer.party/search?q={username}', icon: '🎉', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'ForumOphilia', url: 'https://forumophilia.com/search?q={username}', icon: '📋', category: 'forum', risk: 'high', adult: true },
    { name: 'TheFappeningBlog', url: 'https://thefappeningblog.com/search/{username}', icon: '📰', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'CelebLeaks', url: 'https://celebleaks.net/search/{username}', icon: '🌟', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: '8kun', url: 'https://8kun.top/search#{username}', icon: '♾️', category: 'forum', risk: 'high', adult: true },
    { name: '4chan Archives', url: 'https://boards.4chan.org/search#{username}', icon: '🍀', category: 'forum', risk: 'high', adult: true },
    { name: 'RedditSide', url: 'https://redditside.com/search?q={username}', icon: '🔍', category: 'forum', risk: 'medium' },
    { name: 'RealityForum', url: 'https://realityforum.net/search?q={username}', icon: '🌐', category: 'forum', risk: 'high', adult: true },
    { name: 'Forum.xxx', url: 'https://forum.xxx/search?q={username}', icon: '❌', category: 'forum', risk: 'high', adult: true },
    { name: 'Leaked.zone', url: 'https://leaked.zone/search?q={username}', icon: '🚫', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'AnonIB', url: 'https://anon-ib.co/search/{username}', icon: '👤', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'NoNudeClub', url: 'https://nonude.club/search/{username}', icon: '🚫', category: 'forum', risk: 'high', adult: true },
    { name: 'R34Porn', url: 'https://r34porn.com/search/{username}', icon: '🔞', category: 'forum', risk: 'high', adult: true },
    { name: 'NSFW.xxx', url: 'https://nsfw.xxx/search/{username}', icon: '❌', category: 'forum', risk: 'high', adult: true },
    { name: 'ViperGirls', url: 'https://vipergirls.to/search/{username}', icon: '🐍', category: 'forum', risk: 'high', adult: true },
    { name: 'BDSMLR', url: 'https://bdsmlr.com/search/{username}', icon: '⛓️', category: 'forum', risk: 'high', adult: true },
    { name: 'MyDirtyHobby', url: 'https://mydirtyhobby.com/search/{username}', icon: '🔨', category: 'forum', risk: 'high', adult: true },
    { name: 'PlanetLeak', url: 'https://planetleak.net/search/{username}', icon: '🌍', category: 'forum', risk: 'high', adult: true, urgent: true },
    { name: 'TorLinkBunker', url: 'https://torlinkbunker.com/search/{username}', icon: '🔗', category: 'forum', risk: 'high', adult: true },
    { name: 'NoFaceFreak18', url: 'https://nofacefreak_18/search/{username}', icon: '👻', category: 'forum', risk: 'high', adult: true },
    { name: 'DarkF.app', url: 'https://darkf.app/search/{username}', icon: '🌚', category: 'forum', risk: 'high', adult: true },
    
    // 🟪 Sites de Pornografia/Vídeos que podem ter perfis
    { name: 'SpankBang', url: 'https://spankbang.com/{username}', icon: '💥', category: 'forum', risk: 'high', adult: true },
    { name: 'XVideos', url: 'https://xvideos.com/{username}', icon: '❌', category: 'forum', risk: 'high', adult: true },
    { name: 'XNXX', url: 'https://xnxx.com/{username}', icon: '❌', category: 'forum', risk: 'high', adult: true },
    { name: 'PornHub', url: 'https://pornhub.com/{username}', icon: '🟠', category: 'forum', risk: 'high', adult: true },
    { name: 'XXXStreams', url: 'https://xxxstreams.org/{username}', icon: '📺', category: 'forum', risk: 'high', adult: true },
    { name: 'SxyPrn', url: 'https://sxyprn.com/{username}', icon: '🔞', category: 'forum', risk: 'high', adult: true },
    
    // 🔍 Ferramentas de Busca e Archive
    { name: 'Reddit Search', url: 'https://reddit.com/search?q={username}', icon: '🔎', category: 'forum', risk: 'medium' },
    { name: 'Archive.today', url: 'https://archive.today/{username}', icon: '📚', category: 'archive', risk: 'low' },
    { name: 'Wayback Machine', url: 'https://web.archive.org/web/*/{username}', icon: '⏰', category: 'archive', risk: 'low' }
];

// Extensões e variações de username para busca - EXPANDIDO v3.1
